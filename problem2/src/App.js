...
import CurrencySwapForm from "./components/ConverterForm";
...
function App() {
	...
	return (
		<div className="flex flex-col justify-center items-center h-screen px-2 lg:px-0">
			<Particles id="tsparticles" particlesLoaded={particlesLoaded} options={options} />
			<div className="relative z-10">
				<CurrencySwapForm currencies={currencies} />
				<img className="h-28 w-auto absolute top-[-20%] right-[-2%] lg:right-[-10%]" src="/images/astronaut.png" alt="astronaut" />
			</div>
		</div>
	);
}
